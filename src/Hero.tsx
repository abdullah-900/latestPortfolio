...
if (isdesktop) {
  return (
    <section className="md:px-20 md:py-[3.75rem] px-4 py-10">
      <div className="flex flex-col md:flex-row gap-12 justify-center items-center  md:px-8">
      <div className="flex flex-col justify-center items-center gap-8">
        <div className="flex flex-col justify-around  gap-3 text-Displaytext/Outlined">
